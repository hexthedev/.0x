...
*/
serenade.global().hint("webstorm");
serenade.global().hint("rider");
serenade.global().hint("pycharm");
// serenade.global().pronounce("writer", "rider");


serenade.global().command("configure serenade", async api => {
  await api.runShell("code", ["C:\\Users\\james.mccafferty\\.serenade"], {shell: true})
})